...
<div class="popup-block" id="popup-block-reservation-detail" style="display:none;">
    <div class="col-lg-9 col-lg-offset-2" style="margin-top:50px;">
        <div class="col-lg-12">
            <div class="title-bg">
                <h4 class="title-popup"><b>Reserved</h4>
                <h4 class="title-popup"><?php echo $this->lang->line('ds_lbl_choose_guest_amount'); ?></h4>
            </div>
            <div class="popup-panel" style="text-align: center;height:auto;display:table;">
...
<div class="popup-block" id="popup-reservation-note" style="display:none;">
    <div class="col-lg-6 col-lg-offset-3" style="margin-top:50px;">
        <div class="col-lg-12">
            <div class="title-bg">
                <h4 class="title-popup"><b>Hapus Reservasi</h4>
            </div>
            ...
            <div class="popup-panel" style="height:auto;display:table;">
                ...
                <div class="col-lg-12">
                    <button class="btn btn-std btn-cancel-new-order pull-right"
            ...
            <div class="col-lg-12">
                ...
                <div class="row">
                    <div class="dine-in-container">
                        ...
                        echo '<div id="table-parent" style="'.$display_table.' position:relative;margin:0 auto;width: ' . $default_table_width . ';height:' . $default_table_height . '">';
                        if (!empty($data_table)) {
                            foreach ($data_table as $table) {
                                ...
                                if(!empty($table->is_parent))
                                {
                                 ...
                                 echo '<span class="v-middle" style="' . $span_style . '">' . $table->table_name . '</span></div>';
                             }
