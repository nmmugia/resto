...
?>
    <li class="col-md-6 tag-order" style="padding: 0px;margin-right:3px;width:24%;font-size: 11px;">
      <div class="title-bg title-bg-kitchen" style="padding:0px;">
        <div class="col-md-12" style="padding:0px 0px 0px 2px;">
          ...
          <button title="Print List Menu" class="btn btn-option-list pull-right print_list_menu" style="margin-top: 2px;margin-left:1px;font-size: 15px;font-weight: bold;line-height: 1;padding: 0px 5px;height: 29px;border-radius: 0px !important;" cooking-status="1,2"  order-id="<?php echo (isset($menu_order->order_id) ? $menu_order->order_id  : "")?>"><i class="fa fa-print"></i></button>
          <?php if($setting['checker_group']==0): ?>
                <button class="btn btn-option-list pull-right btn-mode2-post" style="margin-top: 2px;margin-left: 0px;font-size: 15px;font-weight: bold;line-height: 1;padding: 0px 5px;height: 29px;border-radius: 0px !important;">POST</button>
            <?php else: ?>
            <div class="btn-group pull-right" >
                ...
                <ul class="dropdown-menu list-checker-ip" role="menu">
                </ul>
            </div>
          <?php endif; ?>
