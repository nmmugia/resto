...
?>
    <li class="col-md-6" style="padding: 0px;margin-right:3px;width:49%;font-size: 11px;">
      <div class="title-bg title-bg-kitchen" style="padding:0px;">
        <div class="col-md-12" style="padding:0px 0px 0px 2px;background-color: lightgreen;">
          ...
          <button title="Print List Menu" class="btn btn-option-list pull-right print_list_menu" style="margin-top: 0px;margin-left:1px;font-size: 13px;font-weight: bold;line-height: 1;padding: 0px 5px;height: 29px;border-radius: 0px !important;" cooking-status="7"  order-id="<?php echo (isset($menu_order->order_id) ? $menu_order->order_id  : "")?>"><i class="fa fa-print"></i></button>
