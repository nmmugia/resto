...
<div id="page-wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12" style="margin-top:50px;margin-bottom:15px;">
                <div class="col-sm-4">
					<div class="row">
                    ...
                    <div class="panel-wrapper">
                        ...
                        <div class="dark-theme-con">
                            <div class="row" style="margin: 0 !important;">
                                <div class="col-lg-12" style="height: 400px;display: block;overflow-x: hidden;overflow-y:scroll;">
                ...
                <div class="row">
                    <div class="panel-wrapper">                  
                        <div class="col-lg-12" style="padding: 0 !important;" id="menus">
                            ...
                            <div class="dark-theme-con" style="height: 520px">
            ...
            <div class="col-md-4">
                <div class="row">
                    <div class="panel-wrapper">
                        ...
                        <div class="bill-theme-con" style="height:520px;overflow-y: auto;margin-bottom: 10px">                        
                            <div id="table-bill-list" style="max-height: 200px;">
