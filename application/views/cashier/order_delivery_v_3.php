	...
	<div class="row">
	            ...
	            <div class="row">
	                <div class="margin-wrap" style="margin-left: 0px;">
	                    <div class="panel-info panel-info-fixed">
	                        ...
	                        <div class="col-xs-8">
	                            <p class="role-info text-center"><?php echo $cooking_time['start_cooking']; ?> - <?php echo $cooking_time['end_cooking']; ?></p>
	                        </div>
	                        <div class="col-xs-2">
	                        </div>
	                    </div>
		...
		<div class="order-wrapper">
			<div class="col-md-4" id="hidden_customer_dv">
				<div class="row">
					<div class="panel-wrapper" style="margin:0 15px 0px 15px;">
						<div class="title-bg-custom">
							<h4 class="title-name left"style="font-size: 16px;">DATA PELANGGAN</h4>
						</div>
									...
									<div class="form-group" style="margin-bottom:0;">
										...
										<div class="col-sm-6" style="padding:0px;">
											<select id="delivery_cost_id" name="delivery_cost_id" class="form-control" placeholder="<?php echo $this->lang->line('ds_lbl_delivery_cost'); ?>">
												...
												<option value="<?php echo $d->id; ?>" data-is_percentage="<?php echo $d->is_percentage; ?>" 
													data-delivery_cost="<?php echo $d->delivery_cost; ?>" 
													<?php echo ($d->id==$data_order->delivery_cost_id ? "selected" : "") ?>><?php echo $d->delivery_cost_name; ?></option>
												<?php endforeach; ?>
											</select>
										</div>
										<div class="col-sm-6" style="padding:0px;">
						...
						<div class="dark-theme-con hidden-xs hidden-sm">
							<div class="row" style="margin: 0 !important;">
								<div class="col-lg-12 order-container-mini" style="display: block;overflow-x: hidden;overflow-y:auto;">
			...
			<div class="col-md-4">
				<div class="row">
					<div class="panel-wrapper hidden-xs hidden-sm" style="margin: 0 15px 10px 15px" id="hidden_order_dv">
						...
						<div class="dark-theme-con order-container mobile-scroll" style="display: block;overflow-x: hidden;overflow-y:auto;" id="order_delivery_v_html">
							<?php } else { ?>
							<div class="dark-theme-con order-container mobile-scroll" style="display: block;overflow-x: hidden;overflow-y:auto;" id="order_delivery_v_html">
								<?php } }?>
									...
									<table class="bill-table" style="border-bottom:1px solid #e1e1e1;">
										<thead>
											<tr>
												...
												<th style="width:15%;text-align:right;">Jml</th>
