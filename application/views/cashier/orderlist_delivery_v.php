					...
					<div class="margin-wrap">
						<div class="panel-info panel-info-fixed">
							<div class="col-xs-6" style="padding-top:2px;">
								<a href="<?php echo base_url('cashier/order_delivery'); ?>"
				...
				<div class="row">
					<div class="panel-wrapper">
						<div class="title-bg title-bg-take-away">
							...
							<div class="col-xs-6">
								<div class="row">
									<p class="order-time" style="margin-bottom: 3px;"><i class="fa fa-clock-o"></i> ' . (date('d/m/Y H:i', strtotime($order->start_order))) . '</p>
								</div>
                <p class="order-customer" style="text-align: right;margin-right: -15px;">' . $order->customer_phone . '</p>
							</div>
              <p class="order-customer" style="padding-left:2px;">' . $order->customer_address . '</p>
						</div>
                  ...
                  if($val->cooking_status!=3)$counter_not_ready++;
                    ...
                    $counter_processed++;
							...
							<div class="button-wrapper">
								<a href="' . base_url('cashier/order_delivery/' . $order->id) . '"
                  ...
                  if($this->groups_access->have_access('checkout')){
                    echo '<a id="btn_payment_order_delivery" href="' . base_url('cashier/checkout/' . $order->id) . '"
