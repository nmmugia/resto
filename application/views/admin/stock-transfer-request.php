...
<div class="col-lg-12">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading">
            <a href="<?php echo base_url(SITE_ADMIN . '/stock_transfer/add_request'); ?>" class="btn btn-primary pull-right">
                <i class='fa fa-plus'></i>Buat request
            </a> 
            <a href="<?php echo base_url(SITE_ADMIN . '/stock_transfer/request'); ?>" class="btn btn-primary pull-right">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="<?php echo $button['href'] ?>" data-id="<?php echo $item->id; ?>" class="btn btn-default <?php echo isset($button['class']) ? $button['class'] : ''; ?>">  <?php echo $button['action']; ?></a>
                            <?php endforeach; ?>
                        </td>
                    </tr>
                    <?php endforeach; ?>
