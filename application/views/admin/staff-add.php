                            ...
                            <div class="col-lg-12">
                                ...
                                <?php
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <?php
                                            if(isset($required_outlet) && $required_outlet===true){
                                                ...
                                                echo form_dropdown('outlet_id', $outlet_id, $this->input->post('outlet_id'), 'id="outlet_id_chained" field-name = "Outlet" class="form-control" autocomplete="off"');
                                            }
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <?php
                                        echo form_dropdown('identity_type', $identity_type, $this->input->post('identity_type'), 'field-name = "Identity" class="form-control" autocomplete="off"');
                                        ?>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <?php
                                        echo form_dropdown('gender', $gender, $this->input->post('gender'), 'field-name = "Gender" class="form-control" autocomplete="off"');
                                        ?>
                                    </div>
                                </div>
                                <div class="form-group">
