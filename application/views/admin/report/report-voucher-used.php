  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <form id="formFilter" method="POST" target="_blank">
        <input type="hidden" id="type" name="type" value="voucher_used">
...
<div class="panel-body <?php echo ($is_print==true ? "is_print" : ""); ?>">
  <div class="text-center" style="margin-bottom:15px;">
    ...
    <h4><label>Laporan Penggunaan Voucher</label></h4>
  ...
  <table class="table table-bordered <?php echo ($is_print==true ? "border" : ""); ?>" style="font-size: 11px;">
    ...
    <?php
      ...
      foreach($results as $d){
        $total+=$d->total_price;
        echo '<tr>';
        echo '<td>'.$d->voucher_group_name.'</td>';
        echo '<td>'.$d->code.'</td>';
        echo '<td align="right">'.number_format($d->amount,2).'</td>';
    ...
    <input type="hidden" id="report_type" value="voucher_used"/>
  </div>
</div>