  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <form id="formFilter" method="POST" target="_blank">
        <input type="hidden" id="type" name="type" value="bon_bill">
          ...
          <tbody>
            ...
            <tr>
              <td colspan="2" align="right">
                        ...
                        <button id="export_pdf" class="btn btn-success hide_btn" ><i class="fa fa-filter" aria-hidden="true"></i> Export PDF</button>
...
<div class="panel-body <?php echo ($is_print==true ? "is_print" : ""); ?>">
  <div class="text-center" style="margin-bottom:15px;">
    ...
    <h4><label>Laporan BON Bill</label></h4>
  ...
  <table class="table table-bordered <?php echo ($is_print==true ? "border" : ""); ?>" style="font-size: 11px;">
    ...
    <input type="hidden" id="report_type" value="bon_bill"/>
  </div>
</div>