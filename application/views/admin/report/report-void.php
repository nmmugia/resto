...
<input type="hidden" id="type" name="type" value="void"/>
    <div class="clear-export"></div>
        ...
        <div class="panel-body">
                ...
                <tbody>
                 ...
                 <tr>
                    ...
                    <tr>
                        ...
                        <td><label id="total_amount"></label></td>
            ...
            <table class="table table-striped table-bordered table-hover dt-responsive" cellspacing="0" width="100%" id="table-void">
                <thead>
                <tr>
                    <th>Waktu</th>
                    <th>Menu</th>
...
<input type="hidden" id="report_type" value="void"/>
<!-- /.col-lg-12 -->
