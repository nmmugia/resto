  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <form id="formFilter" method="POST" target="_blank">
        <input type="hidden" id="type" name="type" value="attendance_periode">
        ...
        <table class="col-lg-8 form-table-cms">
          <tbody>
						<tr>
							...
							<td class="col-sm-8">
								<div class='input-group date ' id='limit_start_date'>
						...
						<tr>
							...
							<td class="col-sm-8">
								<div class='input-group date ' id='limit_end_date'>
						...
						<tr>
							<td colspan="4" align="right">
								<button id="filter_submit_attendance_periode" class="btn btn-default"><i class="fa fa-filter" aria-hidden="true"></i> Filter</button>
								<button id="export_schedule_pdf" type="submit" class="btn btn-success"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> Export PDF</button>
...
<div class="panel-body <?php echo ($is_print==true ? "is_print" : ""); ?>">
  ...
  <table class="table table-bordered <?php echo ($is_print==true ? "border" : ""); ?>" >
    ...
    <input type="hidden" id="report_type" value="attendance_periode"/>
  </div>
</div>