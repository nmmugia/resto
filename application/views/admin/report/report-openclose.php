...
<input type="hidden" id="type" name="type" value="open_close"/>
    <div class="clear-export"></div>
            <table class="col-lg-8 form-table-cms">
                <tbody>
                 ...
                 <tr>
                    ...
                    <td>   <?php 
                    echo form_dropdown('open_by', $all_cashier, '', 
                        'id="open_by" field-name = "" 
                    ...
                    <tr>
                        ...
                        <td>   <?php 
                        echo form_dropdown('close_by', $all_cashier, '', 
                            'id="close_by" field-name = "" 
                            class="form-control" autocomplete="on"');
                            ?></td>
        ...
        <div class="panel-body">
            ...
            <table class="table table-striped table-bordered table-hover dt-responsive width100" cellspacing="0" width="100%" id="table-open-close">
                <thead>
                <tr>
                    <th>Open</th>
                    <th>Open Oleh</th>
                    <th>Close</th>
                    <th>Close Oleh</th>
                    <th style="width:20% !important">Total Transaksi</th>
                    <th>Total Cash</th>
...
<input type="hidden" id="report_type" value="open_close"/>
<!-- /.col-lg-12 -->
