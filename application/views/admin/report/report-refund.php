...
<div class="col-lg-12">
  <div class="panel panel-default">
    ...
    <div class="panel-body">
      <div class="clearfix"></div>
      <table class="table table-striped table-bordered table-hover dt-responsive" cellspacing="0" width="100%" id="dataTables-refund">
        <thead>
          <tr>
            
            <th>Waktu Refund</th>
            <th>Refund Oleh</th>
            <th>Total Cost Refund</th>
            <th style="width:60px">Aksi</th>
          </tr>
        </thead>
      </table>
      <input type="hidden" id="dataProcessUrl" value="<?php echo $data_url; ?>"/>
      <input type="hidden" id="report_type" value="refund"/>
    </div>
  </div>
</div>