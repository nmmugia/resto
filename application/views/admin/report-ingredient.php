...
<div class="col-lg-12">
    <div class="panel panel-default">
        <div class="panel-heading">
            <table class="col-lg-12 form-table-cms">
                ...
                <tr>
                    ...
                    <td>
                        <select id="inventory_sel" class="def-select form-control">
                            <option value="0" selected="selected">All</option>
                            <?php
        ...
        <div class="panel-body" >
            ...
            <table class="table table-striped table-bordered table-hover dt-responsive sales-table table-show">
                <thead>
                <tr>
...
<input type="hidden" id="report_type" value="ingredient"/>
...
<div class="panel-hidden" style="display:none">
    ...
    <table class="col-lg-12 form-table-cms" style="width:100%;">
        ...
        <tr>
            ...
            <td><label> Bahan</label></td>
            <td>:</td>
            <td><label id='inventory_hidden'></label></td>
        </tr>
        <tr>
            <td><label><?php echo $this->lang->line('column_date_month'); ?></label></td>
            <td>:</td>
