...
<div class="col-lg-12">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <table class="table table-striped table-bordered table-hover dt-responsive history-stock-table">
                <thead>
                <tr>
                    <th class="hideme"><?php echo $this->lang->line('column_date'); ?></th>
                    <th>Outlet</th>
                    <th>Bahan</th>
                    <th>Jumlah</th>
                    <th>Satuan</th>
...
<input type="hidden" id="report_type" value="historyStock"/>
...
<div class="panel-hidden" style="display:none">
    ...
    <table id="table-history-stock-hidden" class="history-stock-table" style="border-collapse: collapse;width:100%;">
