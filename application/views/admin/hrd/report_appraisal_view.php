...
<input type="hidden" id="type" name="type" value="appraisal">
...
?></td>
                    ...
                    <td class="col-sm-8">
                            <div class='input-group date ' id='report_appraisal_period'>
                ...
                <tr>
                    <td colspan="4" align="right">
                        ...
                        <button id="filter_submit_appraisal" class="btn btn-default"><i class="fa fa-filter" aria-hidden="true"></i> Filter</button>
        ...
        <div class="panel-body"> 
            ...
            <table class="table table-striped table-bordered table-hover dt-responsive" cellspacing="0" width="100%" id="report-appraisal">
                <thead>
                <tr>
                    <th>Nama Pegawai</th>
                    <th>Period</th>
            ...
            <input type="hidden" id="dataProcessUrlReportAppraisal"  value="<?php echo $data_url; ?>"/>
