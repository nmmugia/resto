                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label for="floor_name" class="col-sm-3 control-label">Nama Template</label> 
                                    <div class="col-sm-7">
                                                                ...
                                                                <div class="panel-body">
                                                                    <div class="col-lg-12">
                                                                         <div class="form-group">
                                                                            ...
                                                                            <div class="col-sm-10">
                                                                            <input type="text" name="detail_category[<?php echo $indexCategory?>][<?php echo $indexDetail;?>][name]" class="form-control qty-input"
                                                                     ...
                                                                     <div class="col-lg-12">
                                                                         <div class="form-group">
                                                                            <label for="floor_name" class="col-sm-2 control-label">Maximal Point</label> 
                                                                            <div class="col-sm-10"> 
                                                                                <input type="text" name="detail_category[<?php echo $indexCategory?>][<?php echo $indexDetail;?>][point]" class="form-control qty-input"
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="form-group"> 
                                                                <div class="col-sm-4 col-sm-offset-5">
                                                                     <a  category-id="<?php echo $indexCategory; ?>"    class="btn btn-default add_appraisal_detail_category">Tambah</a>
                                                                </div>
                                                            </div>    
                                                        </div>
                                                    </div> 
                             ...
                             <div class="col-lg-12">
                                <div class="form-group">
                                    <div class="col-lg-2 col-sm-offset-5">
                                         <a  id="add_appraisal_category"   class="btn btn-default">Tambah Kategori</a>
                                    </div>
                                 </div>  
                             </div>
                            <div class="col-lg-12">
