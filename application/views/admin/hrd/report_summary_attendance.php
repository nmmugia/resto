...
<form id="formFilter" method="POST">
    <div class="clear-export"></div>
            <table class="col-lg-8 form-table-cms">
                ...
                <tr>
                    <td colspan="4">
                        <button id="filter_submit_attendance" style="float:right;" class="btn btn-default">Filter</button>
                        <button id="export_xls" class="hide_btn btn btn-default" style="float:right;display: none">Export XLS</button>
                        <button id="export_pdf" class="hide_btn btn btn-default" style="float:right;display: none">Export PDF</button>
                    </td>
                </tr>
                </tbody>
            </table>
        ...
        <div class="panel-body"> 
            ...
            <table class="table table-striped table-bordered table-hover dt-responsive" cellspacing="0" width="100%" id="report-attendance">
                <thead>
               <!--  <tr>
                    <th>Tanggal</th>
                    <th>Hadir</th>
