                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                 <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                          <?php    echo form_dropdown('template_id', $template_audits, '', 
                                              'id="template_audit" field-name = "Template" 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="col-sm-1">
                                            <label for="floor_name" class="col-sm-3 control-label" id="total_grade_audit">0</label> 
                                        </div>
                                         ...
                                         <div class="col-sm-1">
                                        <label for="floor_name" class="col-sm-3 control-label " id="max_grade_audit">0</label> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                          <label for="floor_name" class="col-sm-3 control-label" id="total_precentage_audit">55%</label> 
                                    </div>
                                </div>   
                            </div>
