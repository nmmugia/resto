                       ...
                       <div class="row">
                         <?php 
                              echo form_open_multipart(
                                  base_url(SITE_ADMIN . '/hrd_overtime/edit_overtime'), 
                                  array('class' => 'form-horizontal form-ajax'));
                              ?>
                          <div class="col-lg-12">
                            <input type="hidden" name="overtime_id" value="<?php echo $data_overtime->id;?>">
                              <div class="form-group">
                                  <label for="inputEmail3" class="col-sm-2 control-label">Nama Pegawai</label>
                                  <div class="col-sm-6">
                                   <?php echo form_dropdown('user_id', $data_users, 
                                            $data_overtime->user_id, 
                                            'id="loan_user_id" field-name = "Nama Pegawai" 
                                            class="form-control requiredDropdown select2" disabled autocomplete="on"');?>
                                  </div>
                              </div>
                               <div class="form-group">
                                  ...
                                  <div class="col-sm-6">
                                   <div class='input-group date' id='start_time'>
                                    <input type="text" name="start_time" class="form-control" id="over_start_time" onkeydown="return false" value="<?php echo $data_overtime->start_time ?>"> 
                              ...
                              <div class="form-group">
                                  ...
                                  <div class="col-sm-6">
                                   <div class='input-group date' id='end_time'>
                                    <input type="text" name="end_time" class="form-control" id="over_end_time" onkeydown="return false" value="<?php echo $data_overtime->end_time ?>"> 
                                    <span class="input-group-addon">
                                      <span class="glyphicon glyphicon-time"></span>
                                    </span>
                                  </div> 
