...
<input type="hidden" id="type" name="type" value="attendance">
            ...
            <table class="col-lg-8 form-table-cms">
                ...
                <tr>
                    <td colspan="4" align="right">
                        ...
                        <button id="filter_submit_attendance" class="btn btn-default"><i class="fa fa-filter" aria-hidden="true"></i> Filter</button>
