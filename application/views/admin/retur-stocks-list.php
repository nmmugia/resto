    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading">
          <div class="col-lg-7 pull-left" style="padding-left:0px;">
            ...
            <div class="col-lg-2">
              <br>
              <button type="button" class="btn btn-primary" id="trigger_filter_retur_po">Cari</button>
            </div>
          </div>
        ...
        <div class="panel-body">
            <table class="table table-striped table-bordered table-hover dt-responsive" id="dataTables-retur-list">
              <thead>
                <tr>
            ...
            <input type="hidden" id="dataProcessUrl" value="<?php echo base_url(SITE_ADMIN."/retur_order/get_retur_po_data") ?>"/>
            <!-- /.table-responsive -->
        </div>
        <!-- /.panel-body -->
    </div>
