        ...
        <div class="panel-heading">
            <table class="col-lg-4 form-table-cms">
                <tbody>
                    ...
                    <tr>
                        <td>Pembelian</td>
                        <td>: <?php echo convert_is_take_away($bill_detail->is_take_away); ?></td>
                    </tr>

                    <tr>
                        <td><?php echo ($bill_detail->is_take_away==1 ? "Nama" : "Meja") ?></td>
                        <td>: <?php echo ($bill_detail->is_take_away==1 ? $bill_detail->customer_name : $bill_detail->table_name) ?></td>
                    </tr>
