        ...
        <div class="panel-heading">
            <table class="col-lg-12 form-table-cms">
                ...
                <tr>
                    ...
                    <td>
                      <?php 
                         echo form_dropdown('store_sel', $all_store, '', 
                          'id="store_sel" field-name = "Resto" 
                          class="def-select form-control" autocomplete="on"');
                          ?>
                        <?php /*<select id="store_sel" class="def-select form-control">
                ...
                <tr>
                    ...
                    <td>
                      <?php 
                        echo form_dropdown('outlet_sel', $all_category, '', 
                        'id="outlet_sel" field-name = "Outlet" 
                        class="def-select form-control" autocomplete="on"');
                        ?>
                        <?php /*<select id="outlet_sel" class="def-select form-control">
                            <option value="0" selected="selected">All</option>
                            <?php
...
<input type="hidden" id="analytics_type" value="sales"/>
