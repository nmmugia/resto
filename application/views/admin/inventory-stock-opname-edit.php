                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <?php 
                                        echo form_dropdown('input_outlet_id', $ddl_outlet, $form_data->outlet_id, 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <?php 
                                        echo form_dropdown('input_inventory_id', $ddl_inventory, $form_data->inventory_id, 
...
<?php echo form_hidden('id', $form_data->inventory_id); ?>
