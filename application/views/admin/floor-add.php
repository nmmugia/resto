                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label for="floor_name" class="col-sm-2 control-label">Floor</label>

                                    <div class="col-sm-10">
                                        <?php echo form_input($floor_name); ?>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <?php
                                        echo form_dropdown('store_id', $store_id, $this->input->post('store_id'), 'field-name = "Store" class="form-control requiredDropdown" autocomplete="off"');
                                        ?>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-offset-2 col-sm-10">
                                        ...
                                        <a href="<?php echo base_url(SITE_ADMIN . '/floor'); ?>"
