    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading">
          <div class="col-lg-7 pull-left" style="padding-left:0px;">
            ...
            <div class="col-lg-2">
              <br>
              <button type="button" class="btn btn-primary" id="trigger_filter_receive_po">Cari</button>
            </div>
          </div>
        ...
        <div class="panel-body">
            <table class="table table-striped table-bordered table-hover dt-responsive" id="dataTables-receive-purchase-order-list">
              <thead>
                <tr>
            ...
            <input type="hidden" id="dataProcessUrl" value="<?php echo base_url(SITE_ADMIN."/receive_stocks/get_receive_po_data") ?>"/>
            <!-- /.table-responsive -->
        </div>
        <!-- /.panel-body -->
    </div>
