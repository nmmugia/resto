        ...
        <div class="panel-body">
            ...
            <table class="table table-striped table-bordered table-hover dt-responsive sales-table">
                ...
                <tr>
                    ...
                    <th><?php echo $this->lang->line('column_total_item_sell'); ?></th>
                    <th><?php echo $this->lang->line('column_gross_expense'); ?></th>
                    <th><?php echo $this->lang->line('column_gross_revenue'); ?></th>
                    <th><?php echo $this->lang->line('column_gross_profit'); ?></th>
                </tr>
                </thead>
                <tr>
...
<input type="hidden" id="report_type" value="store"/>
<input type="hidden" id="admin_url" value="<?php echo base_url(SITE_ADMIN) ?>"/>
<!-- /.col-lg-12 -->

<!-- /.panel-hidden -->
<div class="panel-hidden" style="display:none">
    <h1 class="page-header"><?php echo $this->lang->line('store_report_title'); ?></h1>
