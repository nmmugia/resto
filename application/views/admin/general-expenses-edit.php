                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <?php echo form_dropdown('ge_id', $ge_id, $form_data->ge_id, 'field-name = "Jenis Pengeluaran" class="form-control requiredDropdown" autocomplete="off"'); ?>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="accounts" class="col-sm-3 control-label">Akun Data</label>

                                    <div class="col-sm-6">
                                        <?php 
                                            echo form_dropdown('account_id', $accounts, $form_data->account_id, 'id="account_id" field-name= "Akun" class="form-control requiredDropdown select2" autocomplete="off"'); 
                                         ?>
                                    </div>
                                </div>
                               <?php }?>
