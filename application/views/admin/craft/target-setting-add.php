                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-9">
                                    <select name="user_id" id="user_id" field-name="nama waiter" class="form-control select2 requireDropDown">
                                      ...
                                      <option value="<?php echo $u->id ?>"><?php echo ucfirst($u->name) ?></option>
                                      <?php endforeach; ?>
                                    </select>
                                  </div>
                                </div>
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-9">
                                    <div class="checkbox">
                                      ...
                                      <label>
                                        <input type="radio" class="target_type" name="target_type" value="2" > Target Penjualan Item
                                      </label>
                                    </div>
                                  </div>
                                </div>
                                <div class="form-group" id="target_by_total_html">
                                  <label for="inventory_id" class="col-sm-3 control-label">Target By Total Penjualan</label>
                                  <div class="col-sm-9">
                                    <input type="text" class="form-control" name="target_by_total" id="target_by_total" placeholder="Masukan Target Penjualan">
                                  </div>
                                </div>
                                <div id="target_by_item_html" style="display:none;">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-9">
                                    ...
                                    <div class="pull-left">
                                      <input type="text" class="form-control requiredTextField col-sm-8" name="reward" id="reward" placeholder="Masukan Reward">
                                    </div>
                                  </div>
                                </div>
                                <div class="form-group">
