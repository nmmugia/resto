                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <small>http://your-domain-here/scheduler/api</small>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="server_sync_url" class="col-sm-2 control-label">Controller</label>

                                    <div class="col-sm-10">
                                        <?php echo form_input($server_sync_controller); ?>
                                        <small>/scheduler/api</small>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-offset-2 col-sm-10">
                                        ...
                                        <a href="<?php echo base_url(SITE_ADMIN . '/system/server_sync'); ?>"
