        ...
        <div class="panel-heading">
            <table class="col-lg-12 form-table-cms">
                ...
                <tr>
                    ...
                    <td><label><?php echo $this->lang->line('column_table'); ?></label></td>
                    <td>
                        <select id="table_sel" class="def-select form-control">
                            ...
                            foreach ($all_table as $table) {
                                ?>
                                <option
                                    value="<?php echo $table->table_id ?>"><?php echo $table->table_name . "-" . $table->store_name . "-" . $table->floor_name; ?></option>
                            <?php
                            }
                            ?>
                        </select>
        ...
        <div class="panel-body">
            ...
            <table class="table table-striped table-bordered table-hover dt-responsive sales-table">
                ...
                <tr>
                    ...
                    <th class="hideme"><?php echo $this->lang->line('column_table_name'); ?></th>
                    <th><?php echo $this->lang->line('column_total_customer'); ?></th>
                    <th><?php echo $this->lang->line('column_sitting_time'); ?></th>
...
<input type="hidden" id="report_type" value="customer"/>
<input type="hidden" id="admin_url" value="<?php echo base_url(SITE_ADMIN) ?>"/>
<!-- /.col-lg-12 -->

<!-- /.panel-hidden -->
<div class="panel-hidden" style="display:none">
    <h1 class="page-header"><?php echo $this->lang->line('customer_report_title'); ?></h1>
    <table class="col-lg-12 form-table-cms" style="width:100%;">
        ...
        <tr>
            ...
            <td><label><?php echo $this->lang->line('column_table'); ?></label></td>
            <td>:</td>
            <td><label id='table_hidden'></label></td>
        </tr>
        <tr>
            <td><label><?php echo $this->lang->line('column_date_year'); ?></label></td>
            <td>:</td>
