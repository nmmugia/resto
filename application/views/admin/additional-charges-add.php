                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label for="charge_name" class="col-sm-2 control-label">Charge Name</label>

                                    <div class="col-sm-10">
                                        <?php echo form_input($charge_name); ?>
                                    </div>
                                </div>
                               <div class="form-group">
                                    <label for="charge_value" class="col-sm-2 control-label">Charge Value</label>

                                    <div class="col-sm-10">
                                        <?php echo form_input($charge_value); ?>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-sm-offset-2 col-sm-10">
                                        ...
                                        <a href="<?php echo base_url(SITE_ADMIN . '/system/additional_charges'); ?>"
