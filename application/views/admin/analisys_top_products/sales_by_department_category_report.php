...
<div class="col-lg-12">
  <div class="panel panel-default">
    <div class="panel-heading">
      <form method="POST" action="<?php echo base_url("admincms/analisys_top_products/sales_by_department_category_report") ?>" id="form_report">
        ...
        <table class="col-lg-8 form-table-cms">
          <tbody>
            ...
            <tr>
              ...
              <td></td>
              <td>
                <input type="radio" name="search[type]" value="department" checked> Department 
                <input type="radio" name="search[type]" value="category" <?php echo ($search['type']=="category" ? "checked" : "") ?>> Category
              </td>
              </tr>
              <tr>
              <td colspan="2" align="right">
                <button class="btn btn-default" name="button" value="filter"><i class="fa fa-filter" aria-hidden="true"></i> Filter</button>
                <button class="btn btn-info" type="button" name="button" value="export_pdf" id="capture_chart" target_capture="#container_chart"><i class="fa fa-photo" aria-hidden="true"></i> Capture</button>
