...
<div class="col-lg-12">
  <div class="panel panel-default">
    <div class="panel-heading">
      <form method="POST" action="<?php echo base_url("admincms/analisys_top_products/hourly_sales_report") ?>">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td colspan="2" align="right">
                ...
                <button class="btn btn-success" name="button" value="export_pdf"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> Export PDF</button>
              </td>
            </tr>
            </tbody>
        </table>
