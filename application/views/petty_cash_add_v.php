         ...
         <div class="col-sm-4">
          <div class="row">
            ...
            <div class="panel-info">
              <div class="col-xs-6">
                <p class="role-info text-left">Kas Kecil</p>
              </div>
              <div class="col-xs-6">
        ...
        <div class="col-lg-12">
          ...
          <div class="row">
            <div class="form-group" style="margin-top:10px;">
              <label for="description" class="col-sm-2 control-label">Pilih Jenis Pengeluaran</label>
              <div class="col-sm-10">
                <?php echo form_dropdown('ge_id', $ge_id, $this->input->post('ge_id'), 'field-name = "Nama Pengeluaran Umum" class="form-control requiredDropdown" autocomplete="off"'); ?>
              </div>
            </div>
            <div class="form-group" style="margin-top:10px;">
              <label for="description" class="col-sm-2 control-label">Deskripsi Pengeluaran</label>
              <div class="col-sm-10">
                <?php echo form_textarea($description); ?>
              </div>
            </div>
            <div class="form-group">
              <label for="amount" class="col-sm-2 control-label">Jumlah Pengeluaran</label>
              <div class="col-sm-10">
