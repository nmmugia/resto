...
<input id="order_type" name="order_type" type="hidden" value="1"/>
                  ...
                  <div class="tab-content">
                        ...
                        <div class="row">
                              <div class="col-lg-12">
                                      ...
                                      <div class="form-group">
                                          ...
                                          <div class="col-sm-10" >
                                          <select name='table_id' id="ddl_table" class="form-control">
                              ...
                              <div class="row">
                                  <div class="panel-wrapper">                  
                                      <div class="col-lg-12" style="padding: 0 !important;" id="menus">
                                          <div class="title-bg-custom">
                                            <div class="input-group" style="float:left;padding-top: 5px;">
                                  ...
                                  <div class="panel-wrapper">
                                      <div class="title-bg-custom">
                                        ...
                                        <div class="col-sm-8" style="margin-top: 6px;">
                                          <select style="display:none;" id="reservation_delivery_cost_id" name="reservation_delivery_cost_id" class="form-control" placeholder="<?php echo $this->lang->line('ds_lbl_delivery_cost'); ?>">
                                            <option value="" data-delivery_cost="">Pilih Ongkos Kirim</option>
                                            <?php foreach($delivery_cost_lists as $d): ?>
                                            <option value="<?php echo $d->id; ?>" data-delivery_cost="<?php echo $d->delivery_cost; ?>" data-is_percentage="<?php echo $d->is_percentage; ?>" ><?php echo $d->delivery_cost_name; ?></option>
                                            <?php endforeach; ?>
                                          </select>
                                        </div>
                                      </div>
                   ...
                   <div class="form-group">
                      <div class="text-center">
                          <button  id="save_reservasi" name="btn_action" value="save"
                                  class="btn btn-std-yellow"><?php echo $this->lang->line('ds_submit_save'); ?>
                          </button>
                          <button id="save_exit_reservasi" name="btn_action" value="save_exit"
